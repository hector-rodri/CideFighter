...
public class GameScreen1 extends JFrame {
	...
	public GameScreen1() {// PANTALLA INICIAL
		...
		// IMAGEN
		ImageIcon icono = new ImageIcon(getClass().getResource("/com/shridhar/personalGame/cide.png")); // Ruta de la
																										// imagen
		...
		btnStartGame.setBounds(53, 237, 241, 55);// UBICACIÓN DEL BOTÓN
		...
		btnCustomize.setBounds(53, 313, 241, 55);// UBICACIÓN
		...
		btnNewButton.setBounds(53, 390, 241, 55);// UBICACIÓN DEL BOTÓN
